...
from src.model.text import (
    LexicalRichnessConstants as LexRichCons,
    ReadabilityConstants as ReadCons
) 
...
def get_words_distribution_feedback(word_frequencies: dict[str, int]) -> str:
    ...
    for word, count in word_frequencies.items():
        ...
        if count > percentile and len(word) > 3:
...
def get_flesch_reading_ease_feedback(flesch_reading_ease: float) -> str:
    ...
    elif flesch_reading_ease < ReadCons.low_flesch_reading_ease_value:
        return ReadCons.low_flesch_reading_ease
    elif flesch_reading_ease < ReadCons.medium_flesch_reading_ease_value:
        return ReadCons.medium_flesch_reading_ease
    elif flesch_reading_ease < ReadCons.high_flesch_reading_ease_value:
...
def get_flesch_kincaid_grade_feedback(flesch_kincaid_grade: float) -> str:
    ...
    elif flesch_kincaid_grade < ReadCons.low_flesch_kincaid_grade_value:
        return ReadCons.low_flesch_kincaid_grade
    elif flesch_kincaid_grade < ReadCons.medium_flesch_kincaid_grade_value:
...
def get_smog_index_feedback(smog_index: float) -> str:
    ...
    elif smog_index < ReadCons.medium_smog_index_value:
        return ReadCons.medium_smog_index
    elif smog_index < ReadCons.high_smog_index_value:
